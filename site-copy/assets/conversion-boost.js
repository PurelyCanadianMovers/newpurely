(function () {
  ...
  var TITLE_OVERRIDES = {
    ...
    "/local-movers-richmond-bc/": "Local Movers Richmond BC | Homes, Condos & Apartments",
    ...
    "/office-movers-burnaby-bc/": "Office Movers Burnaby BC | Commercial Moving",
    "/office-movers-coquitlam-bc/": "Office Movers Coquitlam BC | Commercial Moving",
    "/office-movers-in-vancouver-bc/": "Office Movers Vancouver BC | Corporate Moving",
    "/office-movers-langley-bc/": "Office Movers Langley BC | Commercial Moving",
    "/office-movers-richmond-bc/": "Office Movers Richmond BC | Commercial Moving",
    "/office-movers-surrey-bc/": "Office Movers Surrey BC | Commercial Moving",
    ...
    "/packing-services-burnaby-bc/": "Packing Services Burnaby BC | Moving & Unpacking",
    "/packing-services-coquitlam-bc/": "Packing Services Coquitlam BC | Moving & Unpacking",
    "/packing-services-langley-bc/": "Packing Services Langley BC | Moving & Unpacking",
    "/packing-services-richmond-bc/": "Packing Services Richmond BC | Moving & Unpacking",
    "/packing-services-surrey-bc/": "Packing Services Surrey BC | Moving & Unpacking",
  ...
  var ROUTE_COST_BLOCKS = {
    ...
    "/edmonton-to-vancouver-movers/": {
      ...
      intro: "An Edmonton to Vancouver move typically ranges from about <strong>$2,200+</strong> for a small shipment to <strong>$7,000+</strong> for a larger home. Many 1–2 bedroom moves are estimated around <strong>$2,800–$3,800+</strong>, depending on weight or volume, access, packing, storage, season, and valuation coverage.",
      note: "These estimated moving costs include in-home pickup and delivery, fuel surcharge, Declared Value Protection, and zero deductible. Prices are planning ranges in CAD, not guaranteed quotes. A written estimate requires inventory details, pickup and delivery addresses, access conditions, packing needs, storage timing, and service dates.",
      links: [["Full cost guide", "/long-distance-moving-cost-canada/"], ["Edmonton movers", "/edmonton-long-distance-movers/"], ["Vancouver movers", "/vancouver-long-distance-movers/"], ["Get a written estimate", "/contact/"]],
      rows: [["Studio or small shipment", "$2,200+", "Best for limited furniture or a partial shipment", "4–13 days"], ["1-bedroom", "$2,800+", "Depends on inventory weight or volume, access, and packing", "4–13 days"], ["2-bedroom", "$3,800+", "Common planning range for apartment or condo moves", "4–13 days"], ["3-bedroom", "$5,200+", "Larger household shipment with more labour and space", "4–13 days"], ["4+ bedroom", "$7,000+", "Final quote depends heavily on inventory and services", "4–13 days"]],
    },
    "/movers-edmonton-to-toronto/": {
    ...
    "/toronto-to-edmonton-movers/": {
      ...
      h1: "Toronto to Edmonton Moving Cost, Prices & Transit Time",
      title: "How much does it cost to move from Toronto to Edmonton?",
      intro:
        "A Toronto to Edmonton move typically ranges from about <strong>$2,500</strong> for a small shipment to <strong>$10,000+</strong> for a larger home. Many 1-2 bedroom moves are estimated around <strong>$4,500-$7,000</strong>, depending on weight or volume, access, packing, storage, season, and valuation coverage.",
      note:
        "Prices are planning ranges in CAD, not guaranteed quotes. Toronto to Edmonton pricing depends on inventory weight or volume, pickup and delivery access, stairs, elevators, packing, storage timing, specialty items, and service dates.",
      links: [
        ["Full cost guide", "/long-distance-moving-cost-canada/"],
        ["Toronto movers", "/toronto-long-distance-movers/"],
        ["Edmonton movers", "/edmonton-long-distance-movers/"],
    ...
    "/winnipeg-to-calgary-movers/": {
      ...
      intro:
        "A Winnipeg to Calgary move is about <strong>1,320 km</strong> by road. Planning figures are <strong>$2,300</strong> for a studio, <strong>$3,200</strong> for a 1-bedroom, <strong>$5,100</strong> for a 2-bedroom, <strong>$8,200</strong> for a 3-bedroom, and <strong>$12,000</strong> for a 4+ bedroom home, depending on weight or volume, access, packing, storage, season, and valuation coverage.",
      note:
        "Prices are planning ranges in CAD, not guaranteed quotes. Winnipeg to Calgary pricing depends on inventory weight or volume, pickup and delivery access, stairs, elevators, packing, storage timing, specialty items, and service dates. Typical transit planning is about 3-11 days.",
      links: [
        ["Full cost guide", "/long-distance-moving-cost-canada/"],
        ["Calgary movers", "/calgary-long-distance-movers/"],
        ["Long-distance moving", "/long-distance/"],
      ...
      rows: [
        ["Studio", "$2,300", "Best for limited furniture or a partial shipment", "3-11 days"],
        ["1-bedroom", "$3,200", "Depends on inventory weight or volume, access, and packing", "3-11 days"],
        ["2-bedroom", "$5,100", "Common planning figure for apartment or condo moves", "3-11 days"],
        ["3-bedroom", "$8,200", "Larger household shipment with more labour and space", "3-11 days"],
        ["4+ bedroom", "$12,000", "Final quote depends heavily on inventory and services", "3-11 days"],
      ],
    },
    "/calgary-to-winnipeg-movers/": {
      ...
      intro:
        "A Calgary to Winnipeg move is about <strong>1,320 km</strong> by road. Planning figures are <strong>$2,300</strong> for a studio, <strong>$3,200</strong> for a 1-bedroom, <strong>$5,100</strong> for a 2-bedroom, <strong>$8,200</strong> for a 3-bedroom, and <strong>$12,000</strong> for a 4+ bedroom home, depending on weight or volume, access, packing, storage, season, and valuation coverage.",
      note:
        "Prices are planning ranges in CAD, not guaranteed quotes. Calgary to Winnipeg pricing depends on inventory weight or volume, pickup and delivery access, stairs, elevators, packing, storage timing, specialty items, and service dates. Typical transit planning is about 3-11 days.",
      links: [
        ["Full cost guide", "/long-distance-moving-cost-canada/"],
        ["Calgary movers", "/calgary-long-distance-movers/"],
        ["Long-distance moving", "/long-distance/"],
  ...
  var LOCAL_SEO_BLOCKS = {
    ...
    "/winnipeg-to-calgary-movers/": {
      ...
      intro:
        "A Winnipeg to Calgary move is about 1,320 km by road. Planning figures are $2,300 for a studio, $3,200 for a 1-bedroom, $5,100 for a 2-bedroom, $8,200 for a 3-bedroom, and $12,000 for a 4+ bedroom home, depending on shipment weight or volume, pickup access, delivery access, packing, storage, timing, and valuation coverage.",
      highlights: [
        ["Route distance", "Winnipeg to Calgary is about 1,320 km by road, depending on the exact pickup and delivery addresses."],
        ["Typical transit", "Winnipeg to Calgary long-distance moves are commonly planned around a 3-11 day transit window, depending on shipment size, route planning, consolidation, scheduling, and access."],
        ["Trust proof", "Family-owned since 1991, BBB Accredited, Great Canadian Van Lines agent support, valuation coverage options, and direct moving accountability."],
      ],
      links: [
        ["Full Moving Cost Guide", "/long-distance-moving-cost-canada/"],
    ...
    "/calgary-to-winnipeg-movers/": {
      ...
      intro:
        "A Calgary to Winnipeg move is about 1,320 km by road. Planning figures are $2,300 for a studio, $3,200 for a 1-bedroom, $5,100 for a 2-bedroom, $8,200 for a 3-bedroom, and $12,000 for a 4+ bedroom home, depending on shipment weight or volume, pickup access, delivery access, packing, storage, timing, and valuation coverage.",
      highlights: [
        ["Route distance", "Calgary to Winnipeg is about 1,320 km by road, depending on the exact pickup and delivery addresses."],
        ["Typical transit", "Calgary to Winnipeg long-distance moves are commonly planned around a 3-11 day transit window, depending on shipment size, route planning, consolidation, scheduling, and access."],
        ["Trust proof", "Family-owned since 1991, BBB Accredited, Great Canadian Van Lines agent support, valuation coverage options, and direct moving accountability."],
      ],
      links: [
        ["Full Moving Cost Guide", "/long-distance-moving-cost-canada/"],
  ...
  function enforceVancouverEdmontonTopOrder(path) {
    ...
    if (!root || !quote || !pricing || !trust || !redBar || !header || !hero) return;
    var anchor = root.firstElementChild;
    [quote, pricing, trust, redBar, header, hero].forEach(function (node) {
      var top = node;
  ...
  function initStandaloneChat() {
    ...
    button.addEventListener("click", function () {
      ...
      panel.innerHTML = '<div class="bg-[#CC1A1A] text-white px-4 py-3 flex items-center gap-3"><div class="font-body font-semibold text-sm">PCM Assistant</div><button class="ml-auto" aria-label="Close">×</button></div><div class="flex-1 overflow-y-auto p-4 space-y-3"><div class="bg-gray-100 text-gray-800 rounded-2xl px-3 py-2 text-sm font-body">How can we help with your move?</div></div><div class="border-t border-gray-200 p-3 flex gap-2"><input type="text" placeholder="Ask about our services..." class="flex-1 text-sm font-body border border-gray-300 rounded-full px-4 py-2"><button class="w-9 h-9 rounded-full bg-[#CC1A1A] text-white" aria-label="Send message">↑</button></div>';
