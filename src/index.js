...
const REDIRECTS = new Map([
  ...
  ["/coquitlam-bc/", "/coquitlam/"],
  ["/movers-north-vancouver.html", "/north-vancouver/"],
  ...
  [
    "/2025/07/25/purely-canadian-movers-your-trusted-experts-for-long-distance-moves-across-canada/",
    "/blog/smooth-cross-canada-moving-guide/",
  ],
  ["/pitt-meadows-2", "/pitt-meadows/"],
  ["/pitt-meadows-2/", "/pitt-meadows/"],
  ...
  ["/movers-vancouver-to-calgary/", "/vancouver-to-calgary-movers/"],
  ["/movers-vancouver-to-edmonton", "/vancouver-to-edmonton-movers/"],
  ["/movers-vancouver-to-edmonton/", "/vancouver-to-edmonton-movers/"],
...
const COST_ROUTE_ESTIMATES = [
  ...
  { route: "Halifax to Edmonton", from: "halifax", to: "edmonton", transit: "8-20 days", studio: "$2,800", oneBed: "$5,000", twoBed: "$6,800", threeBed: "$10,000", fourPlus: "$15,000" },
  { route: "Halifax to Vancouver", from: "halifax", to: "vancouver", transit: "10-27 days", studio: "$3,000", oneBed: "$5,300", twoBed: "$7,000", threeBed: "$11,000", fourPlus: "$16,000" },
];
